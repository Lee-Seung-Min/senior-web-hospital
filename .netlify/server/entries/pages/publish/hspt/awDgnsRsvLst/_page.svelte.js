...
<section id="con">
  <div id="content"><div class="list-set form_table"><span>진료 예약 목록</span>
    ...
    <div class="form_table"><span>진료정보</span>
      ...
      <table><colgroup><col style="width:12% ;">
        ...
        <tr><th colspan="4">메모</th></tr>
        ${``}</table>
      ${``}</div>

    <div class="form_table"><span>결제정보</span>
      <table><colgroup><col style="width:12% ;">
          <col style="width:38% ;">
          <col style="width:12% ;">
        ...
        <tr><th>결제일시</th>
          ...
          <th>결제상태</th>
          <td>${escape(dgnsPayStatDesc)}</td></tr></table>
      <p class="ess_info">
        
        
        
        <input type="file" accept="image/*" style="width: 0; height: 0; position: absolute; overflow: hidden; opacity: 0;">
        <button type="button" class="mbtn_b btn-lg">처방전 업로드</button>

        ${``}
        <button type="button" class="mbtn_b btn-lg">결제완료</button>
        <button type="button" class="mbtn_b btn-lg">결제취소</button></p></div>
