    ...
    <div id="content">
        <div class="list-set form_table">
            ...
            <div class="box_search" style="display: flex; align-items: center; gap: 10px;">
                ...
                <button type="button" class="mbtn_n_5 btn-lg ibtn-search" on:click={search}>검색</button>
            </div>

            <div class="form_table list">
            <Grid {data} {columns} {style} {language} on:rowClick={setPayInfo}/>
            </div>
        </div>
...
<!--                <button class="mbtn_p_9" on:click={()=>changePayStat(mpayId)}>결제취소</button>-->
                <button class="btn-lg gray ibtn-cancel" on:click={()=>payCancelPopup=true}>결제취소</button>
            </p>
            <table>
                <colgroup>
                    <col style="width:12% ;"/>
        ...
        <div class="z_box_1">
            ...
            <div class="btn_wrap">
                {#if payInfo.mpayStat == "5"}
                    ...
                    <button class="btn-lg gray" on:click={() => payCancelPopup=false}>아니오</button>
                {:else}
                    <button class="btn-lg" on:click={() => payCancelPopup=false}>확인</button>
                {/if}
            </div>
        </div>
    </section>
...
{#if payCancelAlert}
    <section class="z_alert">
        <div class="z_box_1">
            ...
            <div class="btn_wrap">
                <button class="btn-lg" on:click={() => payCancelAlert=false}>확인</button>
            </div>
        </div>
    </section>
{/if}
